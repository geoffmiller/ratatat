...
> `ink-fast` is a performance-focused fork of Ink.
>
...
| Workload | Ink (ms) | ink-fast (ms) |       Delta |    Speedup |
| -------- | -------: | ------------: | ----------: | ---------: |
...
[![Build Status](https://github.com/geoffmiller/ink-fast/workflows/test/badge.svg)](https://github.com/geoffmiller/ink-fast/actions)
[![npm](https://img.shields.io/npm/dm/ink-fast?logo=npm)](https://npmjs.com/package/ink-fast)
